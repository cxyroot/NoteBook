...
```
docker stop crm-web-${parameters.DOCKER_IMAGE_VERSION}
docker login -u ims-cloud-1638148279655 -p 3253da6576b1b9bb9cbbd58608216506da8ad898 wcl-docker.pkg.coding.net
docker pull ${parameters.DOCKER_IMAGE_URL}:${parameters.DOCKER_IMAGE_VERSION}
docker run -p ${parameters.PORT}:3001 --rm -d \
--name crm-web-${parameters.DOCKER_IMAGE_VERSION} \
${parameters.DOCKER_IMAGE_URL}:${parameters.DOCKER_IMAGE_VERSION} \
```
